"""
This file is from https://github.com/HSLCY/ABSA-BERT-pair
All of the Semeval2014 tests and BERT-pair tests have been removed.
"""
...
def get_y_true():
    ...
    """
    true_data_file = "data/sentihood/test_NLI_M.tsv"
...
def get_y_pred(pred_data_dir):
    ...
    score=[]
    count = 0
    with open(pred_data_dir + "sentihood_loc1_general.txt", "r", encoding="utf-8") as f1_general, \
        open(pred_data_dir + "sentihood_loc1_price.txt", "r", encoding="utf-8") as f1_price, \
        open(pred_data_dir + "sentihood_loc1_safety.txt", "r", encoding="utf-8") as f1_safety, \
        open(pred_data_dir + "sentihood_loc1_transit.txt", "r", encoding="utf-8") as f1_transit:
    ...
    with open(pred_data_dir + "sentihood_loc2_general.txt", "r", encoding="utf-8") as f2_general, \
        open(pred_data_dir + "sentihood_loc2_price.txt", "r", encoding="utf-8") as f2_price, \
        open(pred_data_dir + "sentihood_loc2_safety.txt", "r", encoding="utf-8") as f2_safety, \
        open(pred_data_dir + "sentihood_loc2_transit.txt", "r", encoding="utf-8") as f2_transit:
